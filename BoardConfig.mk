...
# Display
BOARD_EGL_CFG := device/htc/vivow/prebuilt/egl.cfg
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/htc/vivow/bluetooth
BOARD_BLUEDROID_VENDOR_CONF := device/htc/vivow/bluetooth/libbt_vndcfg.txt
